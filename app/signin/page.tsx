...
const Signin = () => {
  const { showAuthFlow, isAuthenticated } = useDynamicContext();
    ...
    <PageWrapper id="page-signin" className="flex h-full">
      <div className="flex flex-col">
        ...
        {isAuthenticated && !showAuthFlow ? (
          <div className="flex w-full justify-center items-center py-5 px-4 text-xl text-gray-200 dark:text-slate-400">
            <svg
              aria-hidden="true"
              role="status"
              className="inline w-5 h-5 me-2 text-gray-200 animate-spin dark:text-slate-500 fill-pink-500"
              viewBox="0 0 100 101"
              fill="none"
          ...
          <DynamicConnectButton buttonClassName="flex-auto w-full justify-center items-center py-4 px-4 bg-pink-500 hover:bg-pink-600 active:bg-pink-700 rounded-2xl text-white text-xl">
            Continue
