          ...
          {isAuthenticated && !showAuthFlow ? (
            <div className="flex justify-center items-center py-4 px-4 text-xl text-slate-400 dark:text-slate-300">
              <svg
                aria-hidden="true"
                role="status"
                className="inline w-5 h-5 me-2 animate-spin text-slate-400 dark:text-slate-500 fill-pink-500"
                viewBox="0 0 100 101"
                fill="none"
            ...
            <DynamicConnectButton buttonClassName="w-full justify-center items-center py-4 px-4 text-xl text-white bg-pink-500 hover:bg-pink-600 active:bg-pink-700 rounded-2xl">
              Continue
